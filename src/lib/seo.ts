...
export const publicRoutes = [
  ...
  { changeFrequency: "monthly", description: "Answer Engine Optimisation in Scotland for clearer entities, evidence, direct answers, structured knowledge, schema, and technically accessible source content.", path: "/answer-engine-optimisation-scotland", priority: 0.94, title: "Answer Engine Optimisation Scotland" },
  { changeFrequency: "monthly", description: "A Scotland-wide AEO agency for technical audits, structured knowledge, schema, answer-ready content, deterministic assistants, and implementation.", path: "/aeo-agency-scotland", priority: 0.95, title: "AEO Agency Scotland" },
  { changeFrequency: "monthly", description: "AI visibility assessment and implementation for Scottish organisations, focused on source accuracy, entity clarity, structured knowledge, and careful monitoring.", path: "/ai-visibility-scotland", priority: 0.93, title: "AI Visibility Scotland" },
  { changeFrequency: "monthly", description: "Practical AI systems for Scottish organisations, including controlled assistants, structured knowledge, portals, internal tools, and maintained workflows.", path: "/ai-systems-scotland", priority: 0.91, title: "AI Systems Scotland" },
  { changeFrequency: "monthly", description: "AI automation for Scottish organisations, combining reliable workflow rules, structured data, validation, human review, and useful AI assistance.", path: "/ai-automation-scotland", priority: 0.91, title: "AI Automation Scotland" },
  { changeFrequency: "monthly", description: "Deterministic assistants for Scottish organisations using approved knowledge, explicit rules, source links, controlled fallbacks, and answer ownership.", path: "/deterministic-assistants-scotland", priority: 0.9, title: "Deterministic Assistants Scotland" },
  { changeFrequency: "monthly", description: "Internal business systems for Scottish organisations: staff portals, workflows, project tools, approvals, structured knowledge, and dashboards.", path: "/internal-business-systems-scotland", priority: 0.9, title: "Internal Business Systems Scotland" },
  { changeFrequency: "monthly", description: "Bespoke software development for Scottish SMEs, including portals, internal systems, workflow applications, structured platforms, and integrations.", path: "/bespoke-software-development-scottish-smes", priority: 0.9, title: "Bespoke Software Development for Scottish SMEs" },
  { changeFrequency: "monthly", description: "Technical AEO support for Oban organisations, grounded in structured visitor information, events, multilingual content, and controlled answers.", path: "/aeo-agency-oban", priority: 0.9, title: "AEO Agency Oban" },
  { changeFrequency: "monthly", description: "AI visibility for Oban tourism, hospitality, marine, event, and service organisations, focused on accurate public sources and direct answers.", path: "/ai-visibility-oban", priority: 0.89, title: "AI Visibility Oban" },
  { changeFrequency: "monthly", description: "Answer Engine Optimisation for Oban organisations, connecting visitor questions, service facts, evidence, technical access, schema, and local knowledge.", path: "/answer-engine-optimisation-oban", priority: 0.89, title: "Answer Engine Optimisation Oban" },
  { changeFrequency: "monthly", description: "AI visibility audits for Inverness organisations, covering entities, services, Highland coverage, evidence, public sources, and dated answer observations.", path: "/ai-visibility-inverness", priority: 0.89, title: "AI Visibility Inverness" },
  { changeFrequency: "monthly", description: "Answer Engine Optimisation for Inverness organisations, connecting technical SEO, Highland coverage, evidence, direct answers, schema, and knowledge.", path: "/answer-engine-optimisation-inverness", priority: 0.89, title: "Answer Engine Optimisation Inverness" },
  { changeFrequency: "monthly", description: "Practical AI and structured knowledge systems for West Highland tourism, hospitality, marine, events, and distributed organisations.", path: "/ai-systems-west-highlands", priority: 0.89, title: "AI Systems West Highlands" },
  { changeFrequency: "monthly", description: "Business automation for West Highland organisations, connecting enquiries, bookings, events, documents, approvals, and distributed team handovers.", path: "/business-automation-west-highlands", priority: 0.88, title: "Business Automation West Highlands" },
  ...
  { changeFrequency: "monthly", description: "AI visibility audits for Edinburgh organisations: dated answer observations, entity and service clarity, supporting sources, and prioritised owned-source gaps.", path: "/ai-visibility-edinburgh", priority: 0.92, title: "AI Visibility Edinburgh" },
  ...
  "@graph": [
    {
      ...
      alternateName: ["mccaigs studio", "mccaigs technical studio Scotland"],
      knowsAbout: [
    ...
    },
    {
      ...
      image: socialImageUrl,
      name: "mccaigs.com",
      alternateName: ["mccaigs official website", "mccaigs technical studio Scotland"],
      potentialAction: {
        "@type": "SearchAction",
