...
export const publicRoutes = [
  ...
  { changeFrequency: "monthly", description: "Answer Engine Optimisation for Scottish organisations, covering technical access, entities, evidence, structured knowledge, schema, and useful direct answers.", path: "/answer-engine-optimisation-scotland", priority: 0.94, title: "Answer Engine Optimisation Scotland" },
